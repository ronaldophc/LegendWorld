package com.ronaldophc.biome;

import com.ronaldophc.LegendWorld;
import com.ronaldophc.biome.desert.CustomBiomeDesert;
import com.ronaldophc.biome.forest.CustomBiomeForest;
import com.ronaldophc.biome.iceplains.CustomBiomeIcePlains;
import com.ronaldophc.biome.jungle.CustomBiomeJungle;
import com.ronaldophc.biome.mesa.CustomBiomeMesa;
import com.ronaldophc.biome.mushroom_shore.CustomBiomeMushroomShore;
import com.ronaldophc.biome.plains.CustomBiomePlains;
    ...
    public static void overrideBiomes() {
        try {
            ...
            List<BiomeBase> biomesToReplace2 = Arrays.asList(
                    BiomeBase.OCEAN, BiomeBase.DEEP_OCEAN, BiomeBase.BEACH, BiomeBase.MESA_PLATEAU_F, BiomeBase.MESA_PLATEAU
            );
            ...
            List<Integer> biomesToReplace4 = Arrays.asList(162, 156, 158, 34, 131, 163, 17, 132, 6, 129);
            ...
            for (int i = 0; i < biomes.length; i++) {
                if (biomes[i] == BiomeBase.MESA) {
                    biomes[i] = new CustomBiomeMesa(37);
                    continue;
                }
            ...
            LegendWorld.logger.severe("Error while overriding biomes: " + e.getMessage());
        }
...
//            }
//        } catch (Exception e) {
//            LegendWorld.logger.warning("Error while overriding biome decorators: " + e.getMessage());
//        }
    }
